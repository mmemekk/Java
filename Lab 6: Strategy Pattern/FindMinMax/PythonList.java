...
class SortedList extends PythonList{
    ...
    public SortedList(int[] array){
        super(array);
        sort(); //any array send to this constructor will be sorted the array already super
        setFindMinMaxStrategy(new SortedFindMinMaxStrategy()); // method will be chosen automatically
    }
